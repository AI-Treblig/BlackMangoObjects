        ...
        const SwiperInstance = new Swiper($main[0], {
            ...
            pagination: {
                ...
                renderBullet: function (index, className) {
                    // Số dạng 01 02 03 + bọc span để CSS
                    return '<span class="' + className + '"><span class="number">' + ((index + 1).toString().padStart(2, '0')) + '</span></span>';
                }
            },
            scrollbar: {
...
wpbingo.lookbook = function(){
  ...
  $(window).on("click.Bst", function(event){
		var $box = $('.wpbingo-block--lookbook:not(.lookbook-simple) .content-product-card .product-card');
		var $box2 = $('.wpbingo-block--lookbook:not(.lookbook-simple) .lookbook-card__point');
		if ( $box.has(event.target).length == 0 && !$box.is(event.target) && $box2.has(event.target).length == 0 && !$box2.is(event.target) ) {
			if($('.wpbingo-block--lookbook:not(.lookbook-simple) .content-product-card').hasClass("active")){
				$('.wpbingo-block--lookbook:not(.lookbook-simple) .content-product-card').removeClass("active").removeAttr('style');
				$('.wpbingo-block--lookbook:not(.lookbook-simple) .lookbook-card__btn').removeClass("active");
			}
		}
	});
	$(".wpbingo-block--lookbook:not(.lookbook-simple) .close-lookbook").on( "click", function() {
		if($('.wpbingo-block--lookbook:not(.lookbook-simple) .content-product-card').hasClass("active")){
			$('.wpbingo-block--lookbook:not(.lookbook-simple) .content-product-card').removeClass("active").removeAttr('style');
			$('.wpbingo-block--lookbook:not(.lookbook-simple) .lookbook-card__btn').removeClass("active");
		}
	...
	$(".wpbingo-section--lookbook.lookbook-simple .lookbook-card__btn").on("click", function() {
		...
		var $id = $(this).data("target");
		var $targetProduct = $("#" + $id, $parent);
		var $carousel = $parent.find('.lookbook-product')[0];
		var swiperInstance = $carousel && $carousel.swiper;
		...
		if (swiperInstance) {
			var targetIndex = $($targetProduct).closest('.swiper-slide').index();
...
wpbingo.vertical_menu = function() {
    var $element2 = $(".categories-vertical-menu"),
        max_number_1600 = $element2.data("max_number_1600") ? $element2.data("max_number_1600") : "15",
        max_number_1400 = $element2.data("max_number_1400") ? $element2.data("max_number_1400") : "8",
        max_number_1100 = $element2.data("max_number_1100") ? $element2.data("max_number_1100") : "6";

    $(window).width() >= 1600 ? wpbingo.appendMoreCategories($element2, max_number_1600)
        : $(window).width() >= 1400 ? wpbingo.appendMoreCategories($element2, max_number_1400)
        : $(window).width() >= 1100 && wpbingo.appendMoreCategories($element2, max_number_1100);
};

wpbingo.vertical_menu_2 = function() {
    var $element2 = $(".categories-vertical-menu_2"),
        max_number_1600 = $element2.data("max_number_1600") ? $element2.data("max_number_1600") : "15",
        max_number_1400 = $element2.data("max_number_1400") ? $element2.data("max_number_1400") : "8",
        max_number_1100 = $element2.data("max_number_1100") ? $element2.data("max_number_1100") : "6";
...
wpbingo.appendMoreCategories = function($element2, limit) {
    var textmore = $element2.data("textmore") ? $element2.data("textmore") : "Load More",
        closemore = $element2.data("textclose") ? $element2.data("textclose") : "Close";

    if ($("ul.vertical-menu > li", $element2).length > limit && $element2.find(".more-wrap").length <= 0) {
        $("ul.vertical-menu", $element2).append(
            '<div class="more-wrap"><span class="more-view">' + textmore + "</span></div>"
        );
    }

    $(".more-wrap", $element2).unbind("click");

    $(".more-wrap", $element2).on("click", function() {
        var this_more = $(this);

        if ($(this).hasClass("open")) {
            $("ul.vertical-menu > li", $element2).each(function(i) {
                if (i > limit - 1) $(this).slideUp();
            });
            $(this).removeClass("open");
            $(this_more).html('<span class="more-view">' + textmore + "</span>");
        } else {
            $("ul.vertical-menu > li", $element2).each(function(i) {
                if (i > limit - 1) $(this).slideDown();
            });
            $(this).addClass("open");
    ...
    $("ul.vertical-menu > li", $element2).css("display", "block");
    $("ul.vertical-menu > li", $element2).each(function(i) {
        if (i > limit - 1) $(this).css("display", "none");
    });
};

wpbingo.accordion_menu = function() {
    var $elements = $(".categories-vertical-menu.accordion");

    $(".select_category__title", $elements).on("click", function() {
        if ($(this).hasClass("active")) {
            $(this).removeClass("active");
    ...
    $(".select_category__title", ".categories-vertical-menu.show").on("click", function() {
        if ($(this).hasClass("active")) {
            $(this).removeClass("active");
    ...
    $(".select_category__title_2", ".categories-vertical-menu_2").on("click", function() {
        if ($(".select_category__title", ".categories-vertical-menu").hasClass("active")) {
            $(".select_category__title", ".categories-vertical-menu").removeClass("active");
            $(".bwp-vertical-navigation > div", $elements).slideUp();
        }
    });
};

wpbingo.accordion_menu_2 = function() {
    var $elements = $(".categories-vertical-menu_2.accordion");

    $(".select_category__title_2", $elements).on("click", function() {
        if ($(this).hasClass("active")) {
            $(this).removeClass("active");
            $(".bwp-vertical-navigation_2 > div", $elements).slideUp();
        } else {
            $(this).addClass("active");
            $(".bwp-vertical-navigation_2 > div", $elements).slideDown();
        }
    });

    $(".select_category__title_2", ".categories-vertical-menu_2.show").on("click", function() {
        if ($(this).hasClass("active")) {
            $(this).removeClass("active");
            $(".bwp-vertical-navigation_2.sticky-vertical > div", ".categories-vertical-menu_2.show").slideUp();
        } else {
            $(this).addClass("active");
            $(".bwp-vertical-navigation_2.sticky-vertical > div", ".categories-vertical-menu_2.show").slideDown();
        }
    });

    $(".select_category__title", ".categories-vertical-menu").on("click", function() {
        if ($(".select_category__title_2", ".categories-vertical-menu_2").hasClass("active")) {
            $(".select_category__title_2", ".categories-vertical-menu_2").removeClass("active");
            $(".bwp-vertical-navigation_2 > div", $elements).slideUp();
        }
    });
};
...
wpbingo.init = function() {
	wpbingo.accordion_menu_2();
	wpbingo.accordion_menu();
	wpbingo.vertical_menu();
	wpbingo.vertical_menu_2();
